...
@require_petsc
def to_mono_petsc(bmat: BlockArray[PETScMat], comm=None, finalize: bool=True) -> PETScMat:
    """
...
@require_petsc
def get_blocks_csr(bmat: BlockArray[PETScMat]) -> Tuple[List[List[Icsr]], List[List[Jcsr]], List[List[Vcsr]]]:
    """
